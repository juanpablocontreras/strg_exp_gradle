...
verbose = settings_file.readline().strip()
if verbose.upper() == 'Y':
    verbose = True
else :
    verbose = False
...
dbhost = settings_file.readline().strip()
if verbose: print('host: ' + dbhost)

dbport = settings_file.readline().strip()
if verbose: print('port: ' + dbport)

dbuser = settings_file.readline().strip()
if verbose: print('user: ' + dbuser)

dbpass = settings_file.readline().strip()
if verbose: print('password: ' + dbpass)

dbname = settings_file.readline().strip()
if verbose: print('database: ' + dbname)

table_name = settings_file.readline().strip()
if verbose: print('table: ' + table_name)

truncate = settings_file.readline().strip()
if verbose: print('truncate: ' + truncate)

num_items = int(settings_file.readline().strip())
if verbose: print('num_items: ' + str(num_items))

mean = int(settings_file.readline().strip())
if verbose: print('mean: ' + str(mean))

std = int(settings_file.readline().strip())
